...
export function PwaRegister() {
  ...
  useEffect(() => {
    ...
    navigator.serviceWorker
      .register("/sw.js")
      .then((reg) => console.log("Franchise PWA SW registered:", reg.scope))
      .catch((err) => console.warn("Franchise PWA SW error:", err));
    ...
    const unsubscribe = onForegroundMessage((payload) => {
      console.log("🔔 Foreground notification in Franchise:", payload);
    });
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-sm font-bold text-white leading-tight">Enable Live Order Alerts</h4>
          <p className="text-xs text-slate-300 mt-1 leading-relaxed">
            Never miss an online order or stock alert. Receive instant sound notifications and desktop popups.
          </p>
